...
Security-sensitive changes update this model, the route/tool permission matrix,
and the exact evidence in `docs/release-gap-matrix.md`. Reports use the private
process in `SECURITY.md`. Known limitations are recorded in
`docs/known-limitations.md`; security invariants such as plaintext credential
